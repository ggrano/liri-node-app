...
// retrieveTweets will retrieve my lastest tweets
function retrieveTweets() {
	...
	var params = {screen_name: 'ggranonubc', count: 20};
...
function retrieveOBDBInfo(movie) {
	...
	var queryStr = 'http://www.omdbapi.com/?t=trilogy' + search + '&plot=full&tomatoes=true';
